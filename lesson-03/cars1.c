/*
  ...
  It asks the user to enter the number of passengers in 
  each car that passes through a toll-booth.

  It keeps track of the number of cars, and passengers.
  When a negative number for passengers is entered, the 
  program ends, and prints out the number of passengers
  and cars that have passed through the toll-booth.
*/
