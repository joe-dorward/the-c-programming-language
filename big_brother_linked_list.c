...
void main(void)
{
  ...
  { /* step one; make new current-waggon */
    ...
    scanf("%s",current_waggon->subject_middle_name_field);

    printf("Enter subject\'s middle name: ");
    scanf("%s",current_waggon->subject_middle_name_field);

    printf("Enter subject\'s last name: ");
    scanf("%s",current_waggon->subject_last_name_field);
    printf("\n");
  ...
  {
    printf("The subject\'s name is: %s,",current_waggon->subject_middle_name_field);
    printf(" %s,",current_waggon->subject_middle_name_field);
    printf(" %s.",current_waggon->subject_last_name_field);
    printf("\n");
