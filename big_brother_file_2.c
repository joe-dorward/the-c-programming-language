...
void main(void)
{
  ...
  printf("1: Show all subjects \n");
  printf("2: Search for birth month \n");
  printf("Enter choice: ");
  scanf("%d",&menu_choice);
  ...
  if (menu_choice == 1)
  {
    ...
    printf("--------------------------------------+");
    printf("\n");
  }  // end of menu_choice == 1
  else if (menu_choice == 2)
  {
    printf("Enter the birth month: ");
    scanf("%s",temp_birth_month);  // birth month is a string

    printf("Subject sharing birth months are: \n\n");

    while (strcmp(array_of_subjects[subject_number].subject_birth_month_field,"") != 0)
    {
      if (strcmp(array_of_subjects[subject_number].subject_birth_month_field,temp_birth_month) == 0)
      {
        // printf("got one \n"); // diagnostic printf()
        printf("+--------------------------------------");
        printf("--------------------------------------+");
