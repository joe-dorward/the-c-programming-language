/*
  ...
  And the tile patern (6 by 8) or whatever
*/
...
float tile_size = 0,
      tile_area = 0,
      number_of_tiles = 0,
      width_number_of_tiles = 0,
      length_number_of_tiles = 0,
      room_width = 0,
	    room_length = 0,
      room_area = 0;
  ...
  width_number_of_tiles = room_width / tile_size;
  length_number_of_tiles = room_length / tile_size;
  ...
  printf(" The number of tiles across the width of the room, ");
  printf("will be: %4.2f tiles \n",width_number_of_tiles);

  printf(" The number of tiles across the length of the room, ");
  printf("will be: %4.2f tiles \n\n",length_number_of_tiles);
}
